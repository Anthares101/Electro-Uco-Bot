    ...
    if (datos == 1):
        ...
        for dato in datos:
            ...
            if (datos2 == 1 or datos3 == 1):
                ...
                url4="https://www.ucotest.es/panel/webservice/consultabot.php?case=log&men=El usuario con id" + message.chat.id + " ha hecho una peticion de listado de productos"
                urllib.urlopen(url4)
    return
