...
def info(message):
    ...
    var = "El usuario con id " + str(message.chat.id) + " ha hecho una peticion de información del pedido con referencia "
    var = var + " ha hecho una peticion de informacion del pedido con referencia "#  referencia
